...
public class NPCTankController : AdvancedFSM 
{
    ...
    protected override void Initialize()
    {
        ...
        GameObject objPlayer = GameObject.Find("PlayerTank");
    ...
    private void ConstructFSM()
    {
        ...
        ChaseState chase = new ChaseState(attackRadius,playerNearRadius, playerTransform);
        ...
        // add all possible transition from this state
        AttackState attack = new AttackState(attackRadius, shootRate, playerTransform, Bullet, bulletSpawnPoint);
